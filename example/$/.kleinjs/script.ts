...
// This TypeScript file would be automatically generated by Klein.js,
// but because Klein.js doesn't exist yet, it was written manually.
			...
			$(
				...
				if (!path) update();
					...
					if (param2 > 0) {
						...
						firstItemFragment = _K_getNode(...path, param1 + 1).content.cloneNode(true);
						param3 = 1;
					}
